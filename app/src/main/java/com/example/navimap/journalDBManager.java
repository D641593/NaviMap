...
//    private List<Journal_list_item> journal_list = new ArrayList<>();
...
//        dbHelper.set_TableName(this.tableName);
    ...
    public void show(){
        ...
        while (cursor.moveToNext()){
            ...
            System.out.println("ImageName : " +cursor.getString(2));
            System.out.println("ImageName : " +cursor.getString(3));
        }
        cursor.close();
        database.close();
        dbHelper.close();
